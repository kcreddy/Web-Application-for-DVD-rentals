...
/**
 * Servlet implementation class admin_film_search_servlet
 */
@WebServlet("/admin_film_search_servlet")
public class admin_film_search_servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public admin_film_search_servlet() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		System.out.println("Customer_id in film_search"+request.getParameter("custId"));
			...
			if(s1=="" && s2=="" && s3=="" && s4=="" && s5==""){
			    ...
			    RequestDispatcher rd=request.getRequestDispatcher("admin_film_search.jsp");  
		...
		if(fblist.size()!=0){  
		   ...
		   // rd.forward(request,response);  
			...
			//request.setAttribute("custId", custId);
			dispatcher = request.getRequestDispatcher("admin_film_search.jsp");
