...
<body bgcolor=#B2E0FC>
<form method="post" action="admin_film_search_servlet">
...
<tr>
   ...
   <td><input type="hidden" name="submit" id="submit" value="Confirm Film Selection" style="height:40px; width:200px" ></td>
   </tr>
<%}%>
<%}%>
